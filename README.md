...
| **DSH P1-C0** | Domain Core Capability Enforcement（role↔capability in record_handoff + decision 不 gate），Independent Review PASS → READY TO LAND | ✅ | (pending commit) |
...
**最後更新**: 2026-08-23 (DSH P1-C0 Domain Core Capability Enforcement)
