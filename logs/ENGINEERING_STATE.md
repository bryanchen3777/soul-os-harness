...
- Current HEAD: `ca3d52f` (fix: relational band slow-climb requires in-window signal (SG-2.1))
- SG-2.1 fix commit: `ca3d52f` (fix: relational band slow-climb requires in-window signal (SG-2.1); **Current HEAD**)
