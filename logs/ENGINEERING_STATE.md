...
- Current HEAD: `51c0c4c` (fix: add_fact writes confidence column (owner-authorized narrow unfreeze))
- confidence fix commit: `51c0c4c` (fix: add_fact writes confidence column (owner-authorized narrow unfreeze); **Current HEAD**)
