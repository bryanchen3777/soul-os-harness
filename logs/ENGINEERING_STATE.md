...
- Current HEAD: `89e9cdf` (feat: time-lapse behavior distribution validation (TL-5))
- SM-4 series commit: `79fe750` (feat: quadruple decision + calibration (SM-4 series); **distinct from Current HEAD**)
- TL-5 commit: `89e9cdf` (feat: time-lapse behavior distribution validation (TL-5); **Current HEAD**)
