...
- Current HEAD: `c30314e` (docs: multimodal perception architecture audit (MS-0))
- MS-0 commit: `c30314e` (docs: multimodal perception architecture audit (MS-0); **Current HEAD**)
