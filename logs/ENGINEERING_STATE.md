...
- Current HEAD: `036d93a` (feat(c-3.1): relational expression injection + P1 delivery routing to public channels)
- C-3.1 implementation commit: `036d93a` (feat(c-3.1): relational expression injection + P1 delivery routing to public channels; **Current HEAD**)
