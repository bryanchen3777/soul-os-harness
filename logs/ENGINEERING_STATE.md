...
- Current HEAD: `29fd27d` (test(tl10): relational expression end-to-end harness (P1 routing + band injection + A2U preserve + fail-safe))
- TL-10 acceptance commit: `29fd27d` (test(tl10): relational expression end-to-end harness (P1 routing + band injection + A2U preserve + fail-safe); **Current HEAD**)
