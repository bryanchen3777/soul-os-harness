...
- Current HEAD: `a0b7aa5` (docs: update README to Phase C-3.1 architecture baseline)
- README baseline commit: `a0b7aa5` (docs: update README to Phase C-3.1 architecture baseline; **Current HEAD**)
