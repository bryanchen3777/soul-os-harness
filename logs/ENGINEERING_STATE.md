...
- Current HEAD: `779a639` (fix: settle_relations 4.1 band-key compat (SG-2.2))
- SG-2.2 fix commit: `779a639` (fix: settle_relations 4.1 band-key compat (SG-2.2); **Current HEAD**)
